...
<div class="col-sm-8 col-xs-12">
  ...
  {% if member.email %}<a href="mailto:{{ member.email }}" target="_blank"><i class="fa fa-envelope fa-3x"></i></a> {% endif %}
  ...
  {% if member.github %} <a href="{{ member.github }}" target="_blank"><i class="fa fa-github fa-3x"></i></a> {% endif %}
